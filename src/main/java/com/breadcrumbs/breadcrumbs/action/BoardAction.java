package com.breadcrumbs.breadcrumbs.action;
...
import com.breadcrumbs.breadcrumbs.service.BoardServiceImpl;
...
public class BoardAction {
	...
	public String board_write_ok(@ModelAttribute BoardDto board)
			throws Exception {
	...
	public ModelAndView board_cont(@RequestParam("board_num") int board_num,
		...
		BoardDto board = boardService.board_cont(board_num);
	...
	public String board_edit_ok(@ModelAttribute BoardDto b,
	...
	public String board_reply_ok(@ModelAttribute BoardDto b,
