...
<link rel="stylesheet" type="text/css" href="/springmember/css/member.css" />
    ...
    <tr>
     ...
     <td>
      <input name="join_zip1" id="join_zip1" size="3" class="input_box"
       />-<input name="join_zip2"
      id="join_zip2" size="3" class="input_box" />
      <input type="button" value="우편번호검색1" class="input_button"
       />
       <input type="button" value="우편번호검색2" class="input_button"
